      ...
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-2 bg-gray-800 rounded-lg p-4">
            <h2 className="text-lg font-bold mb-4">Forex Çiftleri</h2>
            <div className="space-y-2">
              <button
                className={`w-full text-left px-3 py-2 rounded ${
                  selectedPair === 'EURUSD' ? 'bg-indigo-600' : 'hover:bg-gray-700'
                }`}
              ...
              <button
                className={`w-full text-left px-3 py-2 rounded ${
                  selectedPair === 'GBPUSD' ? 'bg-indigo-600' : 'hover:bg-gray-700'
                }`}
                onClick={() => setSelectedPair('GBPUSD')}
              >
                GBP/USD
              </button>
              <button
                className={`w-full text-left px-3 py-2 rounded ${
                  selectedPair === 'USDJPY' ? 'bg-indigo-600' : 'hover:bg-gray-700'
                }`}
